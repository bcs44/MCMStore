...
public class DetailsHumidity extends AppCompatActivity {
    ...
    public void getRecords(){
        new DetailsHumidity.sendGet().execute();
    }
    ...
    private void startTemperatureDetails(String startDate, String endDate) {
        ...
        Intent intent = new Intent(DetailsHumidity.this, BackgroundGetServiceAuth.class);
    ...
    private void registerReceiver() {
        ...
        LocalBroadcastManager.getInstance(DetailsHumidity.this).registerReceiver(
