...
public class DetailsGas extends AppCompatActivity {
    ...
    public void getRecords(){
        new DetailsGas.sendGet().execute();
    }
    ...
    private void startTemperatureDetails(String startDate, String endDate) {
        ...
        Intent intent = new Intent(DetailsGas.this, BackgroundGetServiceAuth.class);
    ...
    private void registerReceiver() {
        ...
        LocalBroadcastManager.getInstance(DetailsGas.this).registerReceiver(
