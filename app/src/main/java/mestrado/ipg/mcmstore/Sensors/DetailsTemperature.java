...
public class DetailsTemperature extends AppCompatActivity {
    ...
    public void getRecords(){
        new DetailsTemperature.sendGet().execute();
    }
    ...
    private void startTemperatureDetails(String startDate, String endDate) {
        ...
        Intent intent = new Intent(DetailsTemperature.this, BackgroundGetServiceAuth.class);
    ...
    private void registerReceiver() {
        ...
        LocalBroadcastManager.getInstance(DetailsTemperature.this).registerReceiver(
