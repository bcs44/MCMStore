...
public class MarcacaoAssembleiaa extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        etInitialDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(MarcacaoAssembleiaa.this, initialDate, myCalendarInitial
        ...
        etInitialTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(MarcacaoAssembleiaa.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void sendToBD() {
        ...
        Intent myIntent = new Intent(MarcacaoAssembleiaa.this, PostBD.class);
    ...
    private void addEvent() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_CALENDAR) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MarcacaoAssembleiaa.this,
    ...
    private void getPlaces() {
        Intent myIntent = new Intent(MarcacaoAssembleiaa.this, GetBD.class);
        myIntent.putExtra("urlStrg", "https://bd.ipg.pt:5500/ords/bda_1701887/place/all");
        myIntent.putExtra("activity", "mestrado.ipg.mcmstore.MarcacaoAssembleiaa");
        startActivity(myIntent);
    }
